...
void MX_FREERTOS_Init(void) {
  ...
  osThreadDef(printfTask, Printf_Task, osPriorityIdle, 0, 256);
  ...
  osThreadDef(refereeUsartTas, Referee_Usart_Task, osPriorityIdle, 0, 256);
...
/**
* @brief Function implementing the refereeUsartTas thread.
* @param argument: Not used
* @retval None
*/
