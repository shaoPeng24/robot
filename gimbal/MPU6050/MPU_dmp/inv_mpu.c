...
/*
 ******************************************************************************************************************************
Name       ：	u8 run_self_test(void)
Description：	mpu6050自测试
Return     ：      0,正常
    	        其他,失败
 ******************************************************************************************************************************
*/
uint8_t run_self_test(void)
{
	...
	if (result==0x3) 
	{
		...
		accel_sens_z = 0;//取消对重力的校准，始终以-Z为重力方向
		accel[0] *= accel_sens;
		accel[1] *= accel_sens_z;
		accel[2] *= accel_sens;
...
/*
 ******************************************************************************************************************************
Name       ：	unsigned short inv_orientation_matrix_to_scalar(const signed char *mtx)
Description：	陀螺仪方向控制
 ******************************************************************************************************************************
*/
...
/*
 ******************************************************************************************************************************
Name       ：	unsigned short inv_row_2_scale(const signed char *row)
Description：	方向转换
 ******************************************************************************************************************************
*/
...
/*
 ******************************************************************************************************************************
Name       ：	void mget_ms(unsigned long *time)
Description：	空函数,未用到
 ******************************************************************************************************************************
*/
...
void mgetdelay_ms(uint8_t time){
...
/*
 ******************************************************************************************************************************
Name       ：	u8 mpu_dmp_init(void)
Description：	mpu6050,dmp初始化
Return     ：      0,正常
                其他,失败
 ******************************************************************************************************************************
*/
uint8_t MPU_dmpInit(void)
{
	uint8_t res=0;
...
/*
 ******************************************************************************************************************************
Name       ：	u8 mpu_dmp_get_data(float *pitch,float *roll,float *yaw)
Description：	得到dmp处理后的数据
 ...
 ******************************************************************************************************************************
*/
uint8_t MPU_dmpGetData(float *pitch,float *roll,float *yaw)
{
